        ...
        <>
            <div className="fixed h-screen w-screen z-0 top-0 left-0 opacity-70 overflow-hidden">
                <div
                    ...
                    style={{
                        backgroundImage: `radial-gradient(circle at 50% 50%,${hexToRgba("#ffff00")}, ${hexToRgba("#ffd300", 0)})`,
                        filter: `50px`,
                ...
                <div
                    ...
                    style={{
                        backgroundImage: `radial-gradient(circle at 50% 50%,${hexToRgba("#3cdfff")}, ${hexToRgba("#8aecff", 0)})`,
                        filter: `50px`,
                        borderRadius: `50% 22% 40% 80%`,
                        height: `60vh`,
                        width: `60vh`,
