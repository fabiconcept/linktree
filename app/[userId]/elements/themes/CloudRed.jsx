...
export default function CloudRed() {
    return (
        <div className="clouds fixed h-screen w-screen z-0 top-0 left-0 opacity-70 overflow-hidden bg-red-300 bg-opacity-25">
            <div className="absolute sm:-left-[10%] top-[-20vh] scale-y-[-1] -left-[25%] animate-bounce">
                <Image 
                    ...
                    height={500} 
                    width={500} 
                    className="animate-pulse object-fit -rotate-12 sm:w-[25rem] w-[15rem] filter hue-rotate-[150deg]" 
                />
            </div>
