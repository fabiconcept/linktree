...
export default function ShareCard() {
    ...
    return (
        <ShareContext.Provider value={{ currentPage, setCurrentPage, myLink }}>
            <div className="absolute -right-4 sm:w-fit w-0 h-fit -translate-y-[5px] px-4 pt-2 pb-5 overflow-hidden navCard">
                <div
                    className={`w-[365px] bg-white rounded-3xl border-b flex flex-col gap-2 border-l p-2 border-r text-sm max-h-[70vh] overflow-y-auto ${showShareCard ? "enterCard" : "leaveCard"}`}
