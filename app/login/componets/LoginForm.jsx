...
export default function LoginForm() {
    const [seePassord, setSeePassord] = useState(false);
        ...
        <div className="flex-1 sm:p-12 p-8 flex flex-col">
            ...
            <section className="mx-auto py-10 w-full sm:w-5/6 md:w-3/4 lg:w-2/3 xl:w-1/2 flex-1 flex flex-col justify-center">
                ...
                <form className="py-8 sm:py-12 flex flex-col gap-4 sm:gap-6 w-full">
                    <div className="flex items-center py-2 sm:py-3 px-4 sm:px-6 rounded-md dropshadow-bad bg-black bg-opacity-5 text-base sm:text-lg w-full">
                    ...
                    <div className="flex items-center relative py-2 sm:py-3 px-4 sm:px-6 rounded-md bg-black bg-opacity-5 text-base sm:text-lg">
                        <input
