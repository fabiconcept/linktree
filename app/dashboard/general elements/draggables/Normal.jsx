                        ...
                        <div className='grid sm:pr-2 gap-2 place-items-center'>
                            <div className='cursor-pointer scale-[0.8] sm:scale-100'>
                                <label class="relative flex justify-between items-center group p-2 text-xl">
                                    ...
                                    <span class="w-9 h-6 flex items-center flex-shrink-0 ml-4 p-1 bg-gray-400 rounded-full duration-300 ease-in-out peer-checked:bg-green-600 after:w-4 after:h-4 after:bg-white after:rounded-full after:shadow-md after:duration-300 peer-checked:after:translate-x-3 group-hover:after:translate-x-[2px]"></span>
                                </label>
                            </div>
